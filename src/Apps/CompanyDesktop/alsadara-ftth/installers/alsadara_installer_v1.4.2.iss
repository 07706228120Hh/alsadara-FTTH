...
AppName=Alsadara
AppVersion=1.4.2
AppVerName=Alsadara v1.4.2 - نظام إدارة شبكات FTTH
...
AllowNoIcons=yes
OutputDir=Distribution_v1.4.2\Installer
OutputBaseFilename=Alsadara_v1.4.2_Setup
...
Root: HKLM; Subkey: "SOFTWARE\Alsadara Technologies\Alsadara"; ValueType: string; ValueName: "Version"; ValueData: "1.4.2"
