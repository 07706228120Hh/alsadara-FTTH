...
AppName=Alsadara
AppVersion=1.6.0
AppVerName=Alsadara v1.6.0 - نظام إدارة شبكات FTTH
...
AllowNoIcons=yes
OutputDir=Distribution_v1.6.0\Installer
OutputBaseFilename=Alsadara_v1.6.0_Setup
...
Root: HKLM; Subkey: "SOFTWARE\Alsadara Technologies\Alsadara"; ValueType: string; ValueName: "Version"; ValueData: "1.6.0"
