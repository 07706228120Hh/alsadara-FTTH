...
class PermissionRegistry {
  ...
  static const List<PermissionEntry> firstSystem = [
    ...
    PermissionEntry(
      ...
      description: 'إدارة المستودعات والمواد وحركات المخزون',
    ...
    PermissionEntry(
      ...
      description: 'إدارة كتالوج المواد المخزنية',
    ...
    PermissionEntry(
      ...
      description: 'إنشاء واعتماد واستلام أوامر الشراء',
    ...
    PermissionEntry(
      key: 'inventory.sales',
      labelAr: 'المبيعات',
      description: 'إنشاء وتأكيد عمليات البيع',
      icon: Icons.point_of_sale_rounded,
      category: 'المالية',
      parent: 'inventory',
      allowedActions: ['view', 'add', 'edit'],
    ...
    PermissionEntry(
      key: 'inventory.dispensing',
      labelAr: 'صرف الفنيين',
      description: 'صرف وإرجاع المواد للفنيين',
    ...
    PermissionEntry(
      key: 'inventory.stock',
      labelAr: 'المخزون والحركات',
      description: 'عرض الأرصدة وتعديل الجرد والتحويل',
    ...
    PermissionEntry(
      ...
      description: 'تقارير التقييم والعُهد والحركات',
